// "Ask about Ammar" — a grounded, tool-using chat agent.
//
...
//   {type:"error", text}
//
// A Groq-hosted model answers questions about Muhammad Ammar, grounded in a bundled
...
const GITHUB_USER = "MuhammadAmmar324";
const MAX_TOOL_TURNS = 3;
const ALLOW_ORIGIN = "*";

const CORE = `Muhammad Ammar — AI & software engineer in Karachi, Pakistan. BSc
Computer Science, Salim Habib University (graduated June 2026). Completed an AI
internship at Systems Limited (Jun–Aug 2025). Co-author on Med-GReF, an in-progress
research working paper. Contact: ammarmosani324@gmail.com,
github.com/MuhammadAmmar324, linkedin.com/in/muhammad-ammar-0483b9276.`;

const INSTRUCTIONS = `You are the assistant on Muhammad Ammar's portfolio site.
Answer questions about Ammar for recruiters, hiring managers, and collaborators.
...
- Use ONLY the CORE facts, the retrieved CONTEXT, and get_github_repos output.
  ...
  ammarmosani324@gmail.com. Never invent employers, dates, titles, or metrics.
- Med-GReF is an in-progress working paper Ammar co-authored — never say it is
  "submitted to NeurIPS", "published", or "peer-reviewed". His final-year project
  is a student collaboration with SUPARCO Pakistan — do not call him a "SUPARCO
  partner" or claim SUPARCO endorses a product.
- Be concise and professional: a few sentences or a short list. No hype, no
  ...
  list instead).
- Write in the third person ("Ammar built…", not "I built…").
...
const STOP = new Set(
  "the and for his her was are does did has have what which who how ammar you your with about into can could would should tell show name give list".split(" ")
);
...
const TOOLS = [
  {
    ...
    function: {
      ...
      description:
        "Live list of Ammar's public GitHub repositories (name, language, stars, last update, description, URL).",
...
async function getGithubRepos() {
  ...
  try {
    const r = await fetch(
      ...
      { headers: { Accept: "application/vnd.github+json", "User-Agent": "ask-about-ammar" } }
    );
